...
CREATE OR REPLACE FUNCTION postgisftw.fire_by_number_and_date(
	fire_number text,
...
BEGIN
    ...
    WHERE t.fire_number LIKE fire_by_number_and_date.fire_number AND t.date_of_interest = fire_by_number_and_date.date_of_interest;
END;
$$

LANGUAGE 'plpgsql' STABLE PARALLEL SAFE;

COMMENT ON FUNCTION postgisftw.fire_by_number_and_date IS 'Filters the featureserv table by fire_number and date';